...
```
【主体与画面需求】
一个换向齿轮零件道具，正面视角，清晰的斜齿锥齿轮剪影，中心轴孔。斜齿沿齿面切分、轮体沿径向分面。精钢齿加黄铜轴套，暖铜主色群、钢灰辅色，少量窄而亮的反光面。白色背景，居中构图，游戏道具概念设计。
...
【笔触、质感与材料】
以高覆盖度、平整而有细微手工变化的数字色块为基础，辅以少量顺形体方向的短笔触与局部色面叠压。金属通过斜齿转折边清楚、明暗对比集中表现；不依赖高清照片贴图、微观孔隙、全画面颗粒噪声或随机碎裂笔触。整体干净、精炼、具有适度的手绘设计感。
...
```
A reversal gear part, game prop, front view, clear helical bevel gear silhouette with a center axle bore. Helical teeth faceted along the tooth faces, wheel body planar-shaded radially. Steel teeth with brass hub, warm copper dominant color group, steel grey secondary, a few narrow bright highlight faces. White background, centered composition, game prop concept design.
