...
```
【主体与画面需求】
一个计量棘轮零件道具，正面视角，清晰的圆形棘轮盘加棘爪杆剪影，齿缘清晰。棘齿沿径向切分、棘爪沿杆身分面。黄铜棘轮加精钢棘爪，青绿主色群、暖铜辅色，少量窄而亮的金属反光面。白色背景，居中构图，游戏道具概念设计。
...
```
A metering ratchet part, game prop, front view, clear circular ratchet wheel silhouette with a pawl lever and distinct teeth. Brass ratchet wheel and steel pawl, teal dominant color group, warm copper secondary, a few narrow bright metallic highlight faces. White background, centered composition, game prop concept design.
