...
COLLABORATION_REQUIRED_FILES = (
    ...
    "Docs/Framework/Development/Dispatch/README.md",
    "Docs/Framework/Development/Dispatch/RoleRouting.md",
    "Docs/Framework/Development/Dispatch/DispatchTemplate.md",
    "Docs/Framework/Development/Dispatch/ActiveAssignments.template.md",
    "Docs/Framework/Development/Dispatch/PauseAndRecovery.md",
    "Docs/Framework/Development/Dispatch/WindowAutomation.md",
    "Docs/Framework/Development/Dispatch/GitIntegration.md",
    "Docs/Framework/Development/Dispatch/WindowRegistry.example.json",
    "Docs/Framework/Development/Dispatch/DecisionArchiveTemplate.md",
    "Docs/Framework/Development/Dispatch/OpenSpecBatching.md",
    "Docs/Framework/Development/Dispatch/Active/README.md",
)

COLLABORATION_ENTRY_LINKS = {
    "AGENTS.md": "Docs/Framework/Development/Dispatch/README.md",
    ".claude/AGENTS.md": "Docs/Framework/Development/Dispatch/README.md",
    ".claude/CLAUDE.md": "Docs/Framework/Development/Dispatch/README.md",
}
...
CONTENT_TARGETS = (
    ...
    "openspec/specs",
    "Docs/Framework/Development/Dispatch",
    "Docs/Framework/Development/AI-Team-Collaboration-Initialization.md",
